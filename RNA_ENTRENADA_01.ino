...
float w1[4] = {-0.956430950127051, 1.48108500341868, 8.38860150267789};
float w2[4] = {3.84356904987299, -6.41891499658161, -8.91139849732207};
float w36 = 3.4407;
float w46 = 9.0986;
float w56 = -12.2898;

// bias de c/neurona
float wb1[4] = {2.67744761188923, -9.86828793873103, 0.848509336771744};
float wb26 = 6.7964;
